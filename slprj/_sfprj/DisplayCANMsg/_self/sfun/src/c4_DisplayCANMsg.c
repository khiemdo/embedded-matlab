...
static void initialize_c4_DisplayCANMsg(SFc4_DisplayCANMsgInstanceStruct
  *chartInstance);
static void initialize_params_c4_DisplayCANMsg(SFc4_DisplayCANMsgInstanceStruct *
  chartInstance);
static void enable_c4_DisplayCANMsg(SFc4_DisplayCANMsgInstanceStruct
  *chartInstance);
static void disable_c4_DisplayCANMsg(SFc4_DisplayCANMsgInstanceStruct
  *chartInstance);
static void c4_update_debugger_state_c4_DisplayCANMsg
...
static void finalize_c4_DisplayCANMsg(SFc4_DisplayCANMsgInstanceStruct
  *chartInstance);
static void sf_gateway_c4_DisplayCANMsg(SFc4_DisplayCANMsgInstanceStruct
  *chartInstance);
static void mdl_start_c4_DisplayCANMsg(SFc4_DisplayCANMsgInstanceStruct
  *chartInstance);
static void initSimStructsc4_DisplayCANMsg(SFc4_DisplayCANMsgInstanceStruct
  *chartInstance);
...
static int16_T c4_b_emlrt_marshallIn(SFc4_DisplayCANMsgInstanceStruct
...
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_c_emlrt_marshallIn(SFc4_DisplayCANMsgInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_d_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_d_emlrt_marshallIn(SFc4_DisplayCANMsgInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_e_emlrt_marshallIn(SFc4_DisplayCANMsgInstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_DisplayCANMsg, const char_T
  *c4_identifier);
static uint8_T c4_f_emlrt_marshallIn(SFc4_DisplayCANMsgInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_DisplayCANMsgInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc4_DisplayCANMsgInstanceStruct
  *chartInstance);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  c4_b_y = NULL;
  sf_mex_assign(&c4_b_y, sf_mex_create("y", &c4_u, 4, 0U, 0U, 0U, 0), false);
  ...
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId)
{
  ...
  int16_T c4_i3;
  (void)chartInstance;
  sf_mex_import(c4_parentId, sf_mex_dup(c4_u), &c4_i3, 1, 4, 0U, 0, 0U, 0);
  c4_b_y = c4_i3;
  sf_mex_destroy(&c4_u);
  return c4_b_y;
}
...
const mxArray *sf_c4_DisplayCANMsg_get_eml_resolved_functions_info(void)
{
  ...
  *c4_identifier)
{
  ...
  c4_b_y = c4_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_DisplayCANMsg), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_DisplayCANMsg);
  return c4_b_y;
}
...
static void init_simulink_io_address(SFc4_DisplayCANMsgInstanceStruct
  *chartInstance)
{
  chartInstance->c4_littleEndianArray = (uint8_T (*)[2])
    ssGetInputPortSignal_wrapper(chartInstance->S, 0);
  chartInstance->c4_y = (int16_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
}
...
void sf_c4_DisplayCANMsg_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c4_DisplayCANMsg_get_post_codegen_info(void);
...
mxArray *sf_c4_DisplayCANMsg_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_DisplayCANMsg_jit_fallback_info(void)
{
...
mxArray *sf_c4_DisplayCANMsg_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c4_DisplayCANMsg(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c4_DisplayCANMsg\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_DisplayCANMsg_get_check_sum(&mxChecksum);
...
static void chart_debug_initialize_data_addresses(SimStruct *S)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S)) {
      ...
      {
        _SFD_SET_DATA_VALUE_PTR(0U, *chartInstance->c4_littleEndianArray);
...
static void sf_opaque_initialize_c4_DisplayCANMsg(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_DisplayCANMsgInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_DisplayCANMsg((SFc4_DisplayCANMsgInstanceStruct*)
    chartInstanceVar);
  initialize_c4_DisplayCANMsg((SFc4_DisplayCANMsgInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c4_DisplayCANMsg(void *chartInstanceVar)
{
  enable_c4_DisplayCANMsg((SFc4_DisplayCANMsgInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_DisplayCANMsg(void *chartInstanceVar)
{
  disable_c4_DisplayCANMsg((SFc4_DisplayCANMsgInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_DisplayCANMsg(void *chartInstanceVar)
{
  sf_gateway_c4_DisplayCANMsg((SFc4_DisplayCANMsgInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c4_DisplayCANMsg(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c4_DisplayCANMsg((SFc4_DisplayCANMsgInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c4_DisplayCANMsg(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c4_DisplayCANMsg((SFc4_DisplayCANMsgInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c4_DisplayCANMsg(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_DisplayCANMsgInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c4_DisplayCANMsg((SFc4_DisplayCANMsgInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc4_DisplayCANMsg((SFc4_DisplayCANMsgInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_DisplayCANMsg(SimStruct *S)
{
  int i;
...
static void mdlRTW_c4_DisplayCANMsg(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_DisplayCANMsg(SimStruct *S)
{
  SFc4_DisplayCANMsgInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc4_DisplayCANMsgInstanceStruct *)utMalloc(sizeof
    (SFc4_DisplayCANMsgInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_DisplayCANMsgInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c4_DisplayCANMsg;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_DisplayCANMsg;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c4_DisplayCANMsg;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_DisplayCANMsg;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_DisplayCANMsg;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_DisplayCANMsg;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_DisplayCANMsg;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_DisplayCANMsg;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_DisplayCANMsg;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_DisplayCANMsg;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c4_DisplayCANMsg;
...
void c4_DisplayCANMsg_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_DisplayCANMsg(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_DisplayCANMsg(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_DisplayCANMsg(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_DisplayCANMsg_method_dispatcher.\n"
